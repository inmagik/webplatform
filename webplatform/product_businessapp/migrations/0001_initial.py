    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_splash', models.URLField(blank=True, null=True)),
                ('app_config', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ...
                ('gallery_data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
                ('product_data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, null=True)),
